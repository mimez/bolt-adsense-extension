...
namespace Bolt\Extension\MichaelMezger\Adsense\Tests;

use Bolt\Tests\BoltUnitTest;
use Bolt\Extension\MichaelMezger\Adsense\AdsenseExtension;
...
class ExtensionTest extends BoltUnitTest
{
    ...
    public function testExtensionBasics()
    {
        ...
        $extension = new AdsenseExtension($app);

        $name = $extension->getName();
        $this->assertSame($name, 'AdsenseExtension');
